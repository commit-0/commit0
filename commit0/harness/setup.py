...
def main(hf_name: str, base_dir: str, config_file: str):
    ...
    for example in dataset:
        ...
        out[repo_name]['local_path'] = os.path.abspath(os.path.join(base_dir, repo_name))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_dir", type=str, default="repos/", help="base directory to write repos to")
