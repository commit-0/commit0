...
def validate_yaml_config(config: dict, required_fields: List[str]):
...
yaml_option = typer.Option(None, '--yaml', callback=load_yaml_config, is_eager=True, help="Path to YAML config file")
